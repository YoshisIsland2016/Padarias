...
<html>
  <head>
    <!-- start: Meta -->
    <meta charset="utf-8">
    <title>Padaria Santa Maria - Login</title>
    <meta name="description"
    content="Bootstrap Metro Dashboard">
      ...
      <div class="row-fluid">
        <div class="row-fluid">
          <div class="login-box">
            ...
            <form class="form-horizontal" action="efetuarLogin"
            method="post">
              <fieldset>
                <div class="input-prepend" title="Username">
                  ...
                  <input class="input-large span10" name="login" id="username" type="text"
                ...
                <div class="input-prepend" title="Password">
                  ...
                  <input class="input-large span10" name="senha" id="password" type="password"
